...
const login = () => {
  return (
    <div className='flex flex-col items-center justify-center gap-[1.2rem] w-[20rem] p-8 rounded-[15px] shadow-lg bg-[#929292] opacity-80 text-center mx-auto border-[3px] border-white'>
        ...
        <button className='flex flex-row items-center justify-evenly gap-2 border border-white-400 rounded-md cursor-pointer transition duration-300 ease-in-out w-[95%] h-[2.8rem] hover:bg-[#e9ecef]'>
            ...
            <p className='text-[0.7rem] text-white font-bold opacity-100'>SIGN IN WITH GOOGLE</p>
        </button>
        ...
        <button className='px-6 py-3 border border-white-400 text-[0.7rem] font-bold rounded-md cursor-pointer transition duration-300 ease-in-out w-[95%] hover:bg-[#e9ecef] text-white mb-4 opacity-100'>CONTINUE AS A GUEST</button>
    </div>
  )
}
