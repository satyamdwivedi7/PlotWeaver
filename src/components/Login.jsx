...
const login = () => {
  return (
    <div className='flex flex-col items-center justify-center gap-[1.2rem] w-[20rem] p-8 rounded-[15px] shadow-lg bg-[#D9D9D9] opacity-50 text-center mx-auto border-[3px] border-white'>
        ...
        <button className='px-6 py-3 border border-gray-400 text-[0.7rem] font-bold rounded-md cursor-pointer transition duration-300 ease-in-out w-[95%] hover:bg-[#e9ecef] text-white mb-4 opacity-100'>CONTINUE AS A GUEST</button>
    </div>
  )
}
